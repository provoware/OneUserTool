...
from todo_modul import TodoModul
...
class HauptModul(QMainWindow):
    ...
    def _build_ui(self):
        ...
        for name in ["Songtexte", "Genres", "Zufallsgenerator", "Todo-Liste"]:
        ...
        self.stack.addWidget(TodoModul())
    ...
    def _toggle_module(self,item):
        idx={"Songtexte":1,"Genres":2,"Zufallsgenerator":3,"Todo-Liste":4}[item.text()]
