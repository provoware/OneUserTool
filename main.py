"""Startpunkt der grafischen Anwendung."""
...
class HauptModul(QMainWindow):
    """Hauptfenster, das die Module und die Navigation verwaltet."""
    ...
    def _build_ui(self):
        """Erstellt Seitenleiste und Modulbereiche."""
    ...
    def _toggle_module(self, item):
        """Zeigt ein Modul an oder blendet es aus."""
