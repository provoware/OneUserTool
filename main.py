...
from dateiumbenennung_modul import DateiumbenennungModul
...
class HauptModul(QMainWindow):
    ...
    def _build_ui(self):
        ...
        for name in ["Songtexte","Genres","Zufallsgenerator","Dateien umbenennen"]:
        ...
        self.stack.addWidget(DateiumbenennungModul())
